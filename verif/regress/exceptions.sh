...
python3 cva6.py --asm_tests "/home/heshds/working_dir/cva6/verif/tests/custom/exceptions/general.S" --iss_yaml cva6.yaml --target cv64a6_imafd_sv39 --iss=$DV_SIMULATORS --gcc_opts="$CC_OPTS -T ../tests/custom/common/test.ld" $DV_OPTS
