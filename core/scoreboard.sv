...
module scoreboard #(
    ...
    input  logic [ariane_pkg::SUPERSCALAR:0][ariane_pkg::REG_ADDR_SIZE_NEW - 1:0] rs1_i,
    ...
    input  logic [ariane_pkg::SUPERSCALAR:0][ariane_pkg::REG_ADDR_SIZE_NEW - 1:0] rs2_i,
    ...
    input  logic     [ariane_pkg::SUPERSCALAR:0][ariane_pkg::REG_ADDR_SIZE_NEW - 1:0] rs3_i,
