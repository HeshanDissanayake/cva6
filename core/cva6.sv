...
#(
    ...
    localparam type scoreboard_entry_t = struct packed {
      ...
      logic [REG_ADDR_SIZE_NEW - 1:0] rs1;  // register source address 1
      logic [REG_ADDR_SIZE_NEW - 1:0] rs2;  // register source address 2
      logic [REG_ADDR_SIZE_NEW - 1:0] rd;  // register destination address
  ...
  // COMMIT <-> ID
  // --------------
  logic [CVA6Cfg.NrCommitPorts-1:0][REG_ADDR_SIZE_NEW-1:0] waddr_commit_id;
